...
function addDnpm(){
    ...
    var content = '  <div class="col-sm" id="dnpm'+qtd+'"><div class="md-form formDNPM mt-7"><input type="number" id="dnpm" name="dnpm'+qtd+'"class="form-control"><label for="materialRegisterFormFirstName">DNPM' + qtd + '</label></div></div>';
